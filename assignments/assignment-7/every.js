...
// function checkPropertyInAllObjects(items1, property1) {
//     return items1.every(function (items) {
//         return items;
//     });
// }
...
//     return matrix1.every(function (matrix) {
//         return matrix[0] * matrix[1] > 0;
//     });
// }
...
// const checkLengthInAllSubArrays = (arrays1, length1) => {
//     return arrays1.every(function (arrays) {
//         return arrays.length === length1;
//     });
// };
...
// function checkPriceGreaterThanValue(products2, price2) {
//     return products2.every(function (products) {
//         return products.price > price2;
//     });
// }
...
function checkAllNumbersEven(numbers2) {
    return numbers2.every(function (number) {
        return number % 2 === 0;
    });
}
...
console.log(checkAllNumbersEven(numbers2));
// Output: false
